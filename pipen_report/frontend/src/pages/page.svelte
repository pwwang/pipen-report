<script>
    ...
    {% if page == 0 %}
    import ProcReport from "../procs/{{proc_slug}}/index.svelte"
    {% else %}
    import ProcReport from "../procs/{{proc_slug}}/index-{{page}}.svelte"
    {% endif %}
    ...
    {% else %}
    import ProcReportToc from "../procs/{{proc_slug}}/toc-{{page}}.svelte"
    {% endif %}
    {% endif %}
