...
def test_ui_table_of_images():
    ...
    result = _ui_table_of_images("table_of_images", contents, {}, 0)
    assert result == (
    ...
    result = _ui_table_of_images("table_of_images:2", contents2, {}, 0)
    assert result == (
        '<div '
    ...
    with pytest.raises(ValueError):
        _ui_table_of_images("table_of_images", contents, {}, 0)
...
def test_ui_accordion():
    ...
    assert result == (
        '<Accordion>\n'
        f'{TAB}<AccordionItem title="Title1">\n'
        f'{TAB * 2}<div>abc</div>\n'
...
def test_render_ui():
    ...
    assert result == _ui_table_of_images("table_of_images", contents2, {}, 0)
